<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Footer.ascx.cs" Inherits="Skap.Controls.Footer" %>
                    ...
                    <div class="gt-footer-widget-items">
                        ...
                        <div class="gt-footer-content">
                            <div class="gt-social-icon d-flex flex-column">
                                <a href="https://api.whatsapp.com/send/?phone=573226913520" target="_blank"><i class="far fa-phone"></i> 322 691 3520</a>
    ...
    <div class="footer-bottom-2 wow fadeInUp">
        <div class="container">
            <div class="footer-wrapper d-flex align-items-center justify-content-between">
                <p class="footer-note">
                    Copyright © 2026 Skap Training Club. – Todos los derechos reservados.
                </p>
            </div>
        </div>
    </div>
